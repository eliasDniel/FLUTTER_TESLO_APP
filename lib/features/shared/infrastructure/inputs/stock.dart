...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if (displayError == StockError.value) return 'El valor debe ser mayor o igual a 0';
    if (displayError == StockError.format) return 'No es un número válido';
  ...
  StockError? validator(int value) {
    ...
    final isIntger = int.tryParse(value.toString()) ?? -1 ;
    if (isIntger == -1) return StockError.format;
