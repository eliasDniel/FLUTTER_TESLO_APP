...
class Price extends FormzInput<double, PriceError> {
  ...
  String? get errorMessage {
    ...
    if (displayError == PriceError.value) return 'El valor debe ser mayor o igual a 0';
    if (displayError == PriceError.format) return 'No es un número válido';
  ...
  PriceError? validator(double value) {
    ...
    final isIntger = double.tryParse(value.toString()) ?? -1;
    if (isIntger == -1) return PriceError.format;
